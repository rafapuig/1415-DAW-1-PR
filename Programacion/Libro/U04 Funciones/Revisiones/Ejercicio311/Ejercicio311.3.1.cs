...
namespace  Programacion.Iniciacion.Actividades.Revisiones.Ejercicio11.V31
{
    static class Ejercicio11
    {
        ...
        {
            //Int32Exentension.Cifras(num)
            foreach (int cifra in num.Cifras()) 
            {
        ...
        static IEnumerable<int> Cifras(int num)
        {
    ...
    static class Int32Exentension
    {
        public static IEnumerable<int> Cifras(this int num)
        {
            int maxPotencia = 0;    //Exponente para potencia 10 de la cifra + significativa
