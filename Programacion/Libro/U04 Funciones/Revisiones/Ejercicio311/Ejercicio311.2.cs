...
namespace  Programacion.Iniciacion.Actividades.Revisiones.Ejercicio11.V2
{
    static class Ejercicio11
    {
        static void Main()
        {
            ...
            MostrarCifras(numero, MostrarCifra);
            Console.ReadKey();
        }
        ...
        static void MostrarCifras(int num, Action<int,bool> mostrarCifra)
        {
