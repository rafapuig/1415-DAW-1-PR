...
namespace Programacion.Funciones.Actividades.Revisiones
{
    class Ejercicio07
    {
        ...
        static void Main()
        {
            ...
            int[] veces = Logica.RepetirExperimento(tiradas, Logica.LanzarDado);
    ...
    static class Logica
    {
        ...
        public static int[] RepetirExperimento(int repeticiones, Func<int> experimento)
        {
            int[] resultados = new int[CarasDado];

            for (int i = 0; i < repeticiones; i++)
            {
                int resultado = experimento();
