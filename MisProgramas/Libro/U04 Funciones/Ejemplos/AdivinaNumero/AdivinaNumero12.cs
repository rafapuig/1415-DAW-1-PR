...
{
    static class AdivinaNumeroVersion12
    {
        ...
        {
            int numeroSecreto = alea.Next(0, 101); //Numero secreto entre 0 y 100
            return numeroSecreto;
        }

        private static void JugarPartida(int intentos)
        {
