...
{
    static class AdivinaNumeroVersion15
    {
        ...
        static void Main()
        {
            ...
            do
            {
                ...
                int numIntentos = ObtenerNumeroIntentos();
                int maximoSecreto = ObtenerMaximoParaNumeroSecreto();
        ...
        private static int ObtenerMaximoParaNumeroSecreto()
        {
            ...
            return maximoSecreto;
        }

        private static int ObtenerNumeroIntentos()
        {
        ...
        private static void JugarPartida(int intentos, int maxSecreto)
        {
            ...
            do
            {
                ...
                int numero = ObtenerNumero(maxSecreto);
        ...
        private static int ObtenerNumero(int maxSecreto)
        {
            Console.Write("Adivina el numero secreto: ");
            int numero;
            while (!Int32.TryParse(Console.ReadLine(), out numero) || numero < 0 || numero > maxSecreto)
                Console.WriteLine("Intruduce un numero valido entre 0 y {0}", maxSecreto);
            return numero;
        }
